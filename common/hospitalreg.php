...
$msg = "";
	if(isset($_POST['txt_name']))
	{
		...
		$sql = "insert into login values('$mail','$pwd','hospital',0)";
		setDatas($sql);
		$sql = "insert into hospital values('$name','$mail','$addr','$contact')";
		setDatas($sql);
		$msg = mysql_error();
		if(!isset($msg) || $msg=='')
		{
			...
			<div class="row">
				<div class="contact-caption clearfix">
					...
					<div class="col-md-6 col-md-offset-1 contact-form">
						...
						<input class="" type="text" name="txt_name" required="required" placeholder="HospitalName"  onkeypress="return verifyText(event)" /><br>
